  ...
  return (
    <div className="w-full max-w-2xl p-6 mx-auto space-y-8 bg-white/50 dark:bg-zinc-950/50 backdrop-blur-xs rounded-xl border-zinc-200/80 dark:border-zinc-800/80">
      <div className="flex items-center justify-center gap-6">
        <Avatar className="w-24 h-24 border-2 rounded-full ">
          <AvatarImage
        ...
        <Button
          variant="outline"
          className="w-24 h-24 transition-colors border-2 border-dashed rounded-full border-zinc-200/80 dark:border-zinc-800/80 hover:border-zinc-300 dark:hover:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-900/50"
        >
          <Sparkles className="w-6 h-6 text-zinc-600 dark:text-zinc-400" />
        </Button>
      </div>
      <p className="w-full text-sm text-center text-zinc-700 dark:text-zinc-300 hover:cursor-pointer">
      ...
      <div className="grid gap-6">
        ...
        <div className="grid gap-2">
          ...
          <Textarea
            ...
            className="bg-white resize-none dark:bg-zinc-900/50 border-zinc-200/80 dark:border-zinc-800/80 focus:border-zinc-300 dark:focus:border-zinc-700 focus:ring-1 focus:ring-zinc-200 dark:focus:ring-zinc-800 placeholder:text-zinc-400 dark:placeholder:text-zinc-600"
            rows={4}
      ...
      <div className="flex justify-end gap-4">
        ...
        <Button className="text-white bg-zinc-900 dark:bg-zinc-100 dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200">
          Save Changes
        </Button>
      </div>
    </div>
